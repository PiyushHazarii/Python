...
# isse title change ho jayega default se 
s.title("Snake Game")
...
food = turtle.Turtle()  # Corrected variable name to 'food'
food.speed(0)
food.shape("square")
food.color("red")
food.fillcolor("blue")
food.penup()
food.ht()  # Hide the food initially
food.goto(150, 200)
food.st()  # Show the food
...
while True:
    ...
    time.sleep(0.1)  # Add a small delay to control the speed
